...
- **Вхідна**: 1 Мбіт/с
- **Вихідна**: 3 Мбіт/с (надсилання електронної пошти)
- **Зовнішє API**: 50 Мбіт/с
...
- Повний опис SLOs  знаходиться у файлі `architecture/system_design/slo.yaml`
